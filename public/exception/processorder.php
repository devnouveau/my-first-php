<?php
  ...
  require_once("file_exceptions.php"); // 사용자정의 익셉션코드 가져오기
...
<html>
  ...
  <body>
    ...
    <?php
      ...
      //서브클래스 예외타입 처리블록을 먼저 실행되게 해야 함
      // (그렇지 않으면 서브클래스예외가 수퍼클래스에 해당되어 수퍼클래스 예외만을 실행하고 끝나기 때문)
      {
         echo "<p><strong>Orders file could not be opened.<br/>
               Please contact our webmaster for help.</strong></p>";
         // echo $foe; // file_exceptions.php에서 오버라이딩한 __toString()출력
      }
      catch (Exception $e)
      {
